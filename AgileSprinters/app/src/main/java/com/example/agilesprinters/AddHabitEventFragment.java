                ...
                if (duration.matches("")) {
                    ...
                    if (durationSetting.matches("mins")) {
                        if (Integer.parseInt(duration) < 0 || Integer.parseInt(duration) > 60) {
                            readyToClose = false;
                            input_duration.setError("minutes value must be between 0 and 60");
                        }
                    }

                    if (durationSetting.matches("hr")) {
                        if (Integer.parseInt(duration) < 0 || Integer.parseInt(duration) > 4) {
                            readyToClose = false;
                            input_duration.setError("hour value must be below 4");
                        } else {
