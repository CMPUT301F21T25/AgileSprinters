...
public class ForumListAdapter extends ArrayAdapter<Forum> {
     ...
     */
    public ForumListAdapter(Context context, ArrayList<Forum> forumPost) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.content_forum_post, parent, false);
        }
