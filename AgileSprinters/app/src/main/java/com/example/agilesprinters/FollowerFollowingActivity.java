...
public class FollowerFollowingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAdapter = new CustomUserListAdapter(this, userDataList);
        ...
        try {
            ...
            Toast.makeText(FollowerFollowingActivity.this, e.toString(),
        ...
        userList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(FollowerFollowingActivity.this, OtherUserScreenActivity.class);
